...
const POSTHOG_KEY = process.env['POSTHOG_API_KEY'] ?? 'phc_REDACTED';
const SENTRY_DSN = process.env['SENTRY_DSN'] ?? 'https://REDACTED@REDACTED.ingest.de.sentry.io/REDACTED';
